...
public class SessionLegacy {
	...
	private static SessionLegacy INSTANCE;

	public static SessionLegacy getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new SessionLegacy();
		}
		return INSTANCE;
	}

	protected SessionLegacy() {
	}
